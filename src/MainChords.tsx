  ...
  return (
    <>
      <div className="orbit-3">
        {/* <button>C</button> */}
        <o-arc className="red grow-2x" onClick={() => playChord("C")} />
        <o-arc className="orange grow-2x" onClick={() => playChord("Dm")} />
        <o-arc className="yellow grow-2x" onClick={() => playChord("Em")} />
        <o-arc className="green grow-2x" onClick={() => playChord("F")} />
        <o-arc className="blue grow-2x" onClick={() => playChord("G")} />
        <o-arc className="indigo grow-2x" onClick={() => playChord("Am")} />
      </div>
